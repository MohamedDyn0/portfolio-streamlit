...
# ==============================================================================
# 1. CONFIGURATION OBLIGATOIRE (DOIT RESTER TOUT EN HAUT, HORS DU MAIN)
# ==============================================================================
st.set_page_config(layout="wide", page_title="Mohamed Dyn", page_icon="👨‍💻")

# 2. LE REMÈDE RADICAL : Injection CSS
# Cela va forcer le conteneur principal à prendre 100% de la largeur
st.markdown("""
    <style>
...
# ==============================================================================
# 3. FONCTION PRINCIPALE (LAZY LOADING)
# ==============================================================================
def main():
    # --- LES IMPORTS SONT DÉPLACÉS ICI POUR NE PAS BLOQUER LA CONFIG ---
    ...
    # ==============================================================================
    # 1. GESTION DE L'ÉTAT (URL & SESSION)
    # ==============================================================================
